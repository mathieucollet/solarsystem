    ...
    <v-container fill-height>
      <v-row>
        <v-col>
          ...
          <p>Désolé, nous n'avons pas trouvé cette page.</p>
          <p>
            Pas d'inquiètude, vous pouvez cliquer sur ce bouton pour retrouver
            votre chemin.
          </p>
          ...
          <v-tooltip right>
            ...
            <span>Oui ca te fait faire un retour...</span>
          </v-tooltip>
        </v-col>
        <v-col>
          <svg
