...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Course app' },
    ],
  ...
  proxy: {
    '/api/planets': {
      target: 'https://api.le-systeme-solaire.net/rest/bodies/',
      pathRewrite: { '^/api/planets': '/' },
    },
    '/api/images': {
      target:
